...
export const OOBEScreen = ({ onComplete }: OOBEScreenProps) => {
  ...
  const { signUp, signIn, signInWithGoogle, isDevMode, loadCloudSettings, checkForConflict } = useOnlineAccount();
            ...
            <div className="animate-fade-in">
              ...
              <div className="space-y-3 mb-8">
                ...
                <button
                  ...
                  className="w-full p-4 bg-white hover:bg-gray-100 border border-slate-300 rounded-xl text-left transition-all group flex items-center gap-4"
                >
                  <div className="w-10 h-10 rounded-lg bg-white flex items-center justify-center shrink-0 border border-slate-200">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-slate-500 text-sm">Quick sign up or sign in</div>
                  </div>
                </button>
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      <div className="text-white font-medium mb-1">Create with email</div>
                      <div className="text-slate-400 text-sm">Use your email address</div>
                    </div>
                ...
                >
                  ...
                  <span className="text-cyan-400">Sign in with email</span>
                </button>
