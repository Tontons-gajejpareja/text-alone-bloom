...
const AVAILABLE_APPS: StoreApp[] = [
  ...
  { id: "ucg", name: "Untitled Card Game", category: "Games", description: "A 21-style card game. Get as close to 21 as you can without going bust! Play against bots of varying difficulty.", version: "1.0.0", size: "12.4 MB", rating: 4.6, downloads: "23.5K", new: true, permissions: ['Graphics', 'Audio'], lastUpdate: '2024-01-25' },
  { id: "dice-roller", name: "Dice Roller", category: "Games", description: "Roll virtual dice for tabletop games, decisions, or just for fun! Supports d4 to d100 with roll history.", version: "1.0.0", size: "0.8 MB", rating: 4.7, downloads: "18.2K", new: true, permissions: [], lastUpdate: '2026-01-13' },
  { id: "reaction-test", name: "Reaction Test", category: "Games", description: "Test your reflexes! How fast can you react? Track your best times and compete against yourself.", version: "1.0.0", size: "0.5 MB", rating: 4.8, downloads: "31.4K", featured: true, new: true, permissions: [], lastUpdate: '2026-01-13' },
